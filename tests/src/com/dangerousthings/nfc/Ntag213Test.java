...
import com.dangerousthings.nearfield.fake.FakeNtag213;
...
public class Ntag213Test extends ActivityInstrumentationTestCase2<MainActivity> {
    Solo solo;
    ...
    public void testVirginTag() throws Exception {
        ...
        FakeNtag213 tag = FakeNtag213.newInstance();
